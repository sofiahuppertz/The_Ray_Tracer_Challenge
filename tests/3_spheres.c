...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/19 19:33:07 by shuppert          #+#    #+#             */
/*   Updated: 2024/05/19 19:35:55 by shuppert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	set_pattern(m, checker(white(), color(0.96863, 0.61961, 0.87843)));
	...
	print_material(*m1);
	set_pattern(m1, ring(white(), color(0.96863, 0.61961, 0.87843)));
	set_material(&wall->shape, m1);

	middle = sphere();
	transform((void *)&middle->shape, translation(-0.5, 1, 0.5));
	t_material *m2 = materialcpy(*m1);
	set_pattern(m2, stripe_pattern(color(0.58824, 0.98039, 0.41961), white()));
	...
	set_pattern(m4, stripe_pattern(color(1, 0.76078, 0.19608), white()));
