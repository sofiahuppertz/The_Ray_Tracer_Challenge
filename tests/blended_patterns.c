...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/19 19:33:12 by shuppert          #+#    #+#             */
/*   Updated: 2024/05/19 19:35:35 by shuppert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	t_pattern *p1 = stripe_pattern(color(0, 1, 0.), white());
	transform((void *)p1, rotation_y(degrees_to_radians(90)));
	t_pattern *p2 = stripe_pattern(white(), color(0, 0, 1));
	add_pattern(&p1, p2);
