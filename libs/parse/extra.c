...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/23 11:09:27 by lchiu             #+#    #+#             */
/*   Updated: 2024/05/23 11:09:27 by lchiu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parse_checker(char **arg, t_parse *p)
{
	...
	p->checker_attr = checker(color(ft_atoi(p->color[0]), ft_atoi(p->color[1]),
				ft_atoi(p->color[2])), color(ft_atoi(p->color_2[0]),
				ft_atoi(p->color_2[1]), ft_atoi(p->color_2[2])));
...
int	parse_stripe(char **arg, t_parse *p)
{
	...
	p->color = ft_split(arg[i + 1], ',');
	p->color_2 = ft_split(arg[i + 2], ',');
	p->stripe_attr = stripe(color(div_255(ft_atoi(p->color[0])),
				div_255(ft_atoi(p->color[1])), div_255(ft_atoi(p->color[2]))),
			color(div_255(ft_atoi(p->color_2[0])),
				div_255(ft_atoi(p->color_2[1])),
				div_255(ft_atoi(p->color_2[2]))), ft_atof(arg[i + 3]),
			ft_atof(arg[i + 4]));
